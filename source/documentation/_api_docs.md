...
|`400`|`[{`<br>`"error": "BadRequestError",`<br>`"message": "Unsupported value for retention_period '(PERIOD)'. Supported periods are from 1 to 26 weeks."`<br>`}]`|Choose a period between 1 and 78 weeks|
