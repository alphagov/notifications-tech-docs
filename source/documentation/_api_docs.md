...
```json
{
  ...
  # optional string - cost of the notification in pounds. The cost does not take free allowance into account
  ...
  "cost_details": {
    ...
    "rate_multiplier": 1 # optional integer - for international sms cost is multiplied by this value
    "rate": "0.0027" # optional string - cost of 1 sms fragment

    # for letters:
    "billable_sheets_of_paper": 2 # optional integer - number of sheets of paper in the letter you sent
