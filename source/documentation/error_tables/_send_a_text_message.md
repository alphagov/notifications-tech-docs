...
|:---|:---|:---|
|`400`|`[{`<br>`"error": "ValidationError",`<br>`"message": "phone_number Too many digits"`<br>`}]`|Check if you've got a correct recipient phone number|
|`400`|`[{`<br>`"error": "ValidationError",`<br>`"message": "phone_number Not enough digits"`<br>`}]`|Check if you've got a correct recipient phone number|
